...
namespace AssemblyCSharp
{
	...
	//-----------------------------------------------------------------------
		...
		public class AStar
		{
			...
			public List<Vector3> PathByVectors
			{
				get
				{
				Point3D[] points = PathByCoordinates;
				List<Vector3> vectorPoints = new List<Vector3>();

				//populate an array of vectors and return it

				foreach(Point3D p in points)
				{
					vectorPoints.Add(new Vector3( (float)p.X, (float)p.Y,(float)p.Z));
				}
